...
export function App(){
    ...
    //             </li>
    //             <li>
    //                 <Link to="/mascotas">Mascotas perdidas</Link>
    //             </li>
    //             <li>
    //                 <Link to="/mascotas">Mascotas encontradas</Link>
    //             </li>
    //         </ul>
    //     </nav>
    //     <Outlet />
    ...
    <header id="header" className="fixed-top mb-5">
      <div className="container-fluid px-lg-10 px-md-9 d-flex align-items-center">
        <div className="row d-flex justify-content-between align-items-center">
          ...
          <Link to="/"> <div className="logo mx-auto mx-lg-1 mr-lg-auto"><img src={appLogo} alt="Logo Hoggo" className="img-fluid" id="logo-header" />  </div> </Link>
          </div>
            ...
            <nav className="nav-menu mx-1">
              <ul className="list-unstyled components justify-content-end">
                ...
                <li className="pt-3 px-2">
                 {/* Login */}
                  <div><i className="icofont-ui-user size-icons naranja"></i></div>
                </li>
              </ul>
            </nav>
          </div>
          ...
          <div className="d-none d-md-block col-md-3">
            <nav className="nav-menu d-none d-md-block mx-2">
              <ul className="list-unstyled components justify-content-end">
                ...
                <li>
                  <div data-section="login"><i className="icofont-ui-user icofont-1x"></i></div>
                </li>
              </ul>
            </nav>
          </div>
